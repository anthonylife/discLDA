...
public:
    ...
    int Totalwords; // total number of words, inclued repeated
    ...
    int init(int argc, char ** argv, int dicnum, int docnum, int headernum);
    ...
    int save_model(string phifile, string thetafile, string tassignfile, \
            string otherparafile);  // simplicity for regression
    ...
    int save_inf_model(string phifile, string thetafile, string tassignfile);
    ...
    // init for estimation
    int init_est();
    int init_est(int dicnum, int docnum, int headernum);
    int init_estc();
    ...
    // init for inference
    int init_inf();
    int init_inf(int dicnum, int docnum, int headernum);
